...
#undef get_lazy
    ...
    {
        return search_visible_vertices(mesh->mesh_vertices[s].p, start_pl, visible_vertex);
    }

    bool visibleSearchInstance::search_visible_vertices(Point start_p, vector<int>& visible_vertex)
    {
        return search_visible_vertices(start_p, get_point_location_in_search(start_p, mesh, false), visible_vertex);
    }

    bool visibleSearchInstance::search_visible_vertices(Point start_p, PointLocation start_pl, vector<int>& visible_vertex)
    {
        timer.start();
        start = start_p;
