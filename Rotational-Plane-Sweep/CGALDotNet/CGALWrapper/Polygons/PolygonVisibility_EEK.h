...
extern "C"
{
	...
	CGALWRAPPER_API void* PolygonVisibility_EEK_GetLocatorAndTEV(void* pwhPtr);

	CGALWRAPPER_API void* PolygonVisibility_EEK_ComputeVisibilityTEVCached(const Point2d& point, void* triExpPtr);
}
