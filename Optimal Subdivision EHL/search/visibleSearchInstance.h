...
//            final_node = nullptr;
    ...
    public:
        ...
        bool search_visible_vertices(Point start_p, vector<int>& visible_vertex);
        bool search_visible_vertices(Point start_p, PointLocation start_pl, vector<int>& visible_vertex);
