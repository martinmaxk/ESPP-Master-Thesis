...
namespace polyanya
{
    ...
    public:
        ...
        int width;
        int height;
        void out_polym(vector<int>& vertices);
        void read(std::istream& infile);
        void read_polygon(std::istream& infile);
        void calculate_from_polygons();
        void precalc_point_location();
        void print(std::ostream& outfile);
        PolyContainment poly_contains_point(int poly, Point& p);
        bool poly_point_location(int polygon, Point& p, PointLocation& pl);
        PointLocation get_point_location(Point& p);
        PointLocation get_point_location(Point& p, int recursion_depth);
        PointLocation get_point_location_naive(Point& p);

        void print_mesh(std::ostream& outfile);
